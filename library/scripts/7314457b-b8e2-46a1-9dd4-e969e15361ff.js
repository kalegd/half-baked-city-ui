...
export default class BasicMovement {
    constructor(instance) {
        ...
        this._movementSpeed = instance['Movement Speed (m/s)'];
    ...
    _updatePositionVR(timeDelta) {
        ...
        this._velocity.x = 0;
        this._velocity.z = 0;
        let xrInputSource = global.inputHandler.getXRInputSource(this._movementHand);
        if(xrInputSource != null) {
            let axes = xrInputSource.gamepad.axes;
            let movingDistance = 10.0 * this._movementSpeed * timeDelta;
