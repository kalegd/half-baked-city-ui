...
export default class PopGameMenu {
    ...
    _updateTexture() {
        ...
        if(this._gameState == "SETTINGS") {
            ...
            this._pivotPoint.position.y = this._position[1];
            this._pivotPoint.position.z = this._position[2];
            this._pivotPoint.rotation.x = this._rotation[0];
    ...
    _isTriggerInputPressed() {
        if(global.deviceType == "XR") {
            let gamepad = global.inputHandler.getXRGamepad(global.popGameController.shootingHand);
