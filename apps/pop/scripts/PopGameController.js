...
export default class PopGameController {
    constructor(params) {
        ...
        this._balloonHitRadius = (params['Balloon Hit Radius'])
            ? params['Balloon Hit Radius']
            : 0.51;
        this._music = params['Background Music'];
        this._soundVolume = (params['Default Volume'])
            ? params['Default Volume']
            : 0.25;
        ...
        if(this._music) {
            ...
            audioLoader.load(this._music, (buffer) => {
